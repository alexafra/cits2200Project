...
public class BeforeListLinked  {
    private Link before;
    private Link after;


    public BeforeListLinked () {
        before = new Link(null, null);
     ...
     */
    public boolean isBeforeFirst(WindowLinked var1) { return var1.link == after; }
     ...
     */
    public boolean isAfterLast(WindowLinked var1) { return var1.link.successor == after; }
